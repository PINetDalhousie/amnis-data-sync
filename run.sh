...
sudo python3 bandwidthPlotScript.py --number-of-switches $SWITCHES --port-type access-port --message-size fixed,10 --message-rate 30.0 --ntopics $TOPICS --replication $SWITCHES --log-dir $RESULT_DIR --switch-ports S1-P1,S2-P1,S3-P1,S4-P1,S5-P1,S6-P1,S7-P1,S8-P1,S9-P1,S10-P1
